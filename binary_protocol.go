...
var (
	...
	operations = map[string]operation{
		"get":        {opcode: 0x00, command: "get", quiet: false, withKey: false},
		"set":        {opcode: 0x01, command: "set", quiet: false, withKey: false},
		"add":        {opcode: 0x02, command: "add", quiet: false, withKey: false},
		"replace":    {opcode: 0x03, command: "replace", quiet: false, withKey: false},
		"delete":     {opcode: 0x04, command: "delete", quiet: false, withKey: false},
		"increment":  {opcode: 0x05, command: "incr", quiet: false, withKey: false},
		"decrement":  {opcode: 0x06, command: "decr", quiet: false, withKey: false},
		"quit":       {opcode: 0x07, command: "quit", quiet: false, withKey: false},
		"flush":      {opcode: 0x08, command: "flush", quiet: false, withKey: false},
		"getq":       {opcode: 0x09, command: "get", quiet: true, withKey: false},
		"noop":       {opcode: 0x0a, command: "noop", quiet: false, withKey: false},
		"version":    {opcode: 0x0b, command: "version", quiet: false, withKey: false},
		"getk":       {opcode: 0x0c, command: "get", quiet: false, withKey: true},
		"getkq":      {opcode: 0x0d, command: "get", quiet: true, withKey: false},
		"append":     {opcode: 0x0e, command: "append", quiet: false, withKey: false},
		"prepend":    {opcode: 0x0f, command: "prepend", quiet: false, withKey: false},
		"stat":       {opcode: 0x10, command: "stat", quiet: false, withKey: false},
		"setq":       {opcode: 0x11, command: "set", quiet: true, withKey: false},
		"addq":       {opcode: 0x12, command: "add", quiet: true, withKey: false},
		"replaceq":   {opcode: 0x13, command: "replace", quiet: true, withKey: false},
		"deleteq":    {opcode: 0x14, command: "delete", quiet: true, withKey: false},
		"incrementq": {opcode: 0x15, command: "incr", quiet: true, withKey: false},
		"decrementq": {opcode: 0x16, command: "decr", quiet: true, withKey: false},
		"quitq":      {opcode: 0x17, command: "quit", quiet: true, withKey: false},
		"flushq":     {opcode: 0x18, command: "flush", quiet: true, withKey: false},
		"appendq":    {opcode: 0x19, command: "append", quiet: true, withKey: false},
		"prependq":   {opcode: 0x1a, command: "prepend", quiet: true, withKey: false},
		"cas":        {opcode: 0x01, command: "cas", quiet: false, withKey: false},
